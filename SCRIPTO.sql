...
CREATE TABLE Emprestimo (CODIGO INT GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, DATAEMPRESTIMO DATE NOT NULL, DATADEVOLUCAO DATE DEFAULT NULL, CODIGOLIVRO INT NOT NULL, CODIGOUSUARIO INT NOT NULL, DEVOLVIDO BOOLEAN DEFAULT FALSE, DELETADO BOOLEAN DEFAULT FALSE, FOREIGN KEY(CODIGOLIVRO) REFERENCES Livro(CODIGO), FOREIGN KEY(CODIGOUSUARIO) REFERENCES Usuario(CODIGO));

CREATE TABLE Multa (CODIGO INT GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, CODIGOEMPRESTIMO INT NOT NULL, DESCRICAO VARCHAR(64) NOT NULL, VALOR DOUBLE NOT NULL, DELETADO BOOLEAN DEFAULT FALSE, FOREIGN KEY(CODIGOEMPRESTIMO) REFERENCES Emprestimo(CODIGO));
