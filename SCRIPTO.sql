...
CREATE TABLE CategoriaUsuario (CODIGO INT GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, NOME VARCHAR(64) NOT NULL, DEVOLUCAO INT NOT NULL);
...
CREATE TABLE Usuario (CODIGO INT GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY, NOME VARCHAR(64) NOT NULL,  SEXO BOOLEAN NOT NULL, ENDERECO VARCHAR(128) NOT NULL, TELEFONE VARCHAR(11) NOT NULL, CODIGOCATEGORIA INT NOT NULL, DELETADO BOOLEAN DEFAULT FALSE, FOREIGN KEY(CODIGOCATEGORIA) REFERENCES CategoriaUsuario(CODIGO));
